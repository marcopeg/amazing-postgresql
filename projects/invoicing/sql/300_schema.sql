...
FROM generate_series(1, 500000) "n", "raw_data";
...
CREATE INDEX "users_idx_1_date_of_birth_btree" ON "users_idx_1" USING btree ("date_of_birth" ASC);
CREATE INDEX "users_idx_2_date_of_birth_hash" ON "users_idx_2" USING hash ("date_of_birth" ASC);
